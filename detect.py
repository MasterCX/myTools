...
def run(
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        # ==================================================================
        mulpicplus = "4"     #1 for normal,2 for 4pic plus,3 for 9pic plus and so on
        ...
        if mulpicplus == "1":
            ...
            for i in range(mulpicplus):
                ...
                for j in range(mulpicplus):
                    ...
                    if x_startpoint + x_smalloccur < xsz:
                        x_real = x_startpoint + x_smalloccur
                    else:
                        x_real = xsz
                        x_startpoint = xsz - int(xsz / mulpicplus * 1.2)
                    # y_real = min(y_startpoint + y_smalloccur, ysz)
                    if y_startpoint + y_smalloccur < ysz:
                        y_real = y_startpoint + y_smalloccur
                    else:
                        y_real = ysz
                        y_startpoint = ysz - int(ysz / mulpicplus * 1.2)
