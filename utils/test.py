...
# p = "D:\\img\\zhizhen\\diaomo\\6428\\"
# binaryImg(p)

def createSmallImg(imgPath):
    img = cv2.imread(imgPath, cv2.IMREAD_UNCHANGED)
    newImg = img[400:2000, 1100:2700]
    cv2.imwrite('1600.png', newImg)


img = cv2.imread('1.jpg', cv2.IMREAD_UNCHANGED)
small = img[3500:4500, 2900:3850]
cv2.imwrite('2.jpg', small)
